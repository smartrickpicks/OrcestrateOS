...
The Patch Submit Modal converts the patch submission flow to a centered modal dialog after validation gates pass. It displays patch type, observation summary, change list, and requires justification.
